      ...
      <div className="container">
        <div className="row mb-5">
          ...
          <div className="col-lg-6">
            ...
            <h1>{product?.name}</h1>
            <p className="text-muted lead">Q{product?.price}</p>
            ...
            <div className="row align-items-stretch mb-4">
              ...
              <div className="col-sm-3 pl-sm-0 mb-4">
                <button
              ...
              <a className="btn btn-link text-dark p-1 mb-4" href="#">
                <i className="far fa-heart mr-2"></i>Añadir a lista de deseos
              </a>
              <br></br>
              <ul className="list-unstyled small d-inline-block">
                ...
                <li className="px-3 py-2 mb-1 bg-white text-muted">
                  ...
                  <a className="reset-anchor ml-2">Productos</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="d-flex justify-content-between">
          <div className="d-flex w-25">
            <span className="mt-2">Evaluar: </span>
            &nbsp; &nbsp;
            <input
