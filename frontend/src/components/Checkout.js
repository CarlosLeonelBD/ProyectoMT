      ...
      <div className="container">
          ...
          <div className="container">
            <div className="row px-4 px-lg-5 py-lg-4 align-items-center">
              <div className="col-lg-6">
                <h1 className="h2 text-uppercase mb-0">Pago</h1>
              </div>
        ...
        {!success && (
          <section className="py-5">
            <h2 className="h5 text-uppercase mb-4">Detalle de pago</h2>
            <div className="row">
              ...
              <div className="col-lg-4">
                <div className="card border-0 rounded-0 p-lg-4 bg-light">
                  <div className="card-body">
                    <h5 className="text-uppercase mb-4">Mi Orden</h5>
        ...
        {success && (
          <section className="py-5">
            <div className="p-5">
              <h1>Has realizado tu pedido con éxito</h1>
              <p style={{ fontSize: "1.2rem" }}>Por favor revise su correo electrónico.</p>
            </div>
          </section>
        )}
      </div>
