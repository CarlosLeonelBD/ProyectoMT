          ...
          <ul id="sidebarnav">
            ...
            <li className="sidebar-item">
              ...
              >
                ...
                <span className="hide-menu">Tablas</span>
              </a>
              <ul
                aria-expanded="false"
              ...
              >
                <li className="sidebar-item">
                  <a href="/users" className="sidebar-link">
                    <span className="hide-menu">Registro Usuarios</span>
                  </a>
                </li>
                <li className="sidebar-item">
                  <a href="/products" className="sidebar-link">
                    <span className="hide-menu">Registro Productos</span>
                  </a>
                </li>
                <li className="sidebar-item">
                  <a href="/history" className="sidebar-link">
                    <span className="hide-menu">Registro Historial</span>
                  </a>
                </li>
              </ul>
            </li>
