        ...
        <thead className="bg-light">
          <tr className="text-center">
            <th className="border-0" scope="col">
              {" "}
              <strong className="text-small text-uppercase">Imagen</strong>
            </th>
            <th className="border-0" scope="col">
              {" "}
              <strong className="text-small text-uppercase">Producto</strong>
            </th>
            <th className="border-0" scope="col">
              {" "}
              <strong className="text-small text-uppercase">Precio</strong>
            </th>
            <th className="border-0" scope="col">
              {" "}
              <strong className="text-small text-uppercase">Cantidad</strong>
            </th>
            <th className="border-0" scope="col">
              {" "}
            ...
            <th className="border-0" scope="col">
              {" "}
              <strong className="text-small text-uppercase">Quitar</strong>
            </th>
          </tr>
        </thead>
        <tbody>
              ...
              <tr className="text-center">
                ...
                <td className="align-middle border-0">
                  <p className="mb-0 small">
                    Q{parseInt(item.quantity) * parseInt(item.product.price)}
                  </p>
                </td>
                <td className="align-middle border-0">
                  <a
