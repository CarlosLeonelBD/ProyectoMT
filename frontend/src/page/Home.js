        ...
        <div className="container">
          ...
          <div className="pt-5">
            <div className="text-center">
              <p className="small text-muted small text-uppercase mb-1">
                Categorias cuidadosamente creadas
              </p>
              <h2 className="h5 text-uppercase mb-4">categorías</h2>
            </div>
            <div className="row">
              <div className="col-md-4 mb-4 mb-md-0">
                <NavLink className="category-item" to="/shop">
                  <img
                    ...
                    alt=""
                  />
                  <strong className="category-item-title">Camaras</strong>
                </NavLink>
              </div>
              <div className="col-md-4 mb-4 mb-md-0">
                <NavLink className="category-item mb-4" to="/shop">
                  <img
                    ...
                    alt=""
                  />
                  <strong className="category-item-title">Servicio Tecnico</strong>
                </NavLink>
                <NavLink className="category-item" to="/shop">
                  <img
                    className="img-fluid"
                    ...
                    alt=""
                  />
                  <strong className="category-item-title">Plataformas de Streaming</strong>
                </NavLink>
              </div>
              <div className="col-md-4">
                <NavLink className="category-item" to="/shop">
                  <img
                    ...
                    alt=""
                  />
                  <strong className="category-item-title">Componentes Electronicos</strong>
                </NavLink>
              </div>
            </div>
          </div>
          <div className="py-5" id="section_product">
            <div>
              ...
              <h2 className="h5 text-uppercase mb-4">Productos con grandes descuentos</h2>
            </div>
          ...
          <div className="py-5" id="section_product">
            <div>
              ...
              <h2 className="h5 text-uppercase mb-4">Gasto en producto para usted</h2>
            </div>
            <div className="row d-block">
